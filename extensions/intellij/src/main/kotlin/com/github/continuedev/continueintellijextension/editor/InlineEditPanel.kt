...
fun makeTextArea(): JTextArea {
    ...
    // Note: UIUtil.HIDE_EDITOR_FROM_DATA_CONTEXT_PROPERTY was removed in recent
    // IntelliJ platform releases (2025.2+). It was a cosmetic hint that hid the
    // editor from data-context lookups; no functional equivalent is required.
    return textArea
}
